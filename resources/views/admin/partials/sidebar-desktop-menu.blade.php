    ...
    <div class="mb-6">
        ...
        <div class="space-y-1.5">
            <a href="{{ route('admin.kategori') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.kategori') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 7h10M7 12h10M7 17h10M4 7h.01M4 12h.01M4 17h.01" /></svg>
            ...
            <a href="{{ route('admin.berita') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.berita') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M19 5H5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2zM7 9h10M7 13h6" /></svg>
    ...
    <div class="mb-6">
        ...
        <div class="space-y-1.5">
            <a href="{{ route('admin.acara-kegiatan') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.acara-kegiatan') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M8 7V3m8 4V3m-9 8h10m-13 9h16a1 1 0 001-1V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a1 1 0 001 1z" /></svg>
            ...
            <a href="{{ route('admin.peraturan') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.peraturan') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 12h6m-6 4h6M7 4h10a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z" /></svg>
    ...
    <div class="mb-6">
        ...
        <div class="space-y-1.5">
            <a href="{{ route('admin.tertib-usaha') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.tertib-usaha') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 12h18M12 3v18" /></svg>
            ...
            <a href="{{ route('admin.tertib-penyelenggaraan') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.tertib-penyelenggaraan') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 2a7 7 0 00-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 00-7-7zm0 9a2 2 0 110-4 2 2 0 010 4z" /></svg>
            ...
            <a href="{{ route('admin.tertib-pemanfaatan') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.tertib-pemanfaatan') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 4h14v16H5zM9 8h6M9 12h6M9 16h4" /></svg>
    ...
    <div class="mb-6">
        ...
        <div class="space-y-1.5">
            ...
            <a href="{{ route('admin.arsip') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.arsip') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6 2h9l5 5v13a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2z" /></svg>
    ...
    <div class="pb-6">
        ...
        <div class="space-y-1.5">
            <a href="{{ route('admin.penandatangan-dokumen') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.penandatangan-dokumen') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 20h9M12 4h9M4 9h16M4 15h16M4 4h4v5H4zM4 15h4v5H4z" /></svg>
            ...
            <a href="{{ route('admin.anggaran-perjadin') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.anggaran-perjadin') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 7h18M6 11h12M9 15h6M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1z" /></svg>
            ...
            <a href="{{ route('admin.perjadin') }}" class="{{ $menuBase }} {{ request()->routeIs('admin.perjadin') ? $menuActive : $menuIdle }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M8 17l4 4 4-4m-4-5v9M4 4h16v4H4z" /></svg>
