<div class="mt-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
    ...
    {{-- Checkbox untuk memilih semua data pada halaman --}}
    ...
    <div class="flex flex-wrap items-center gap-2">
        ...
        {{-- Tombol hapus data yang dipilih secara massal (disabled jika belum ada pilihan) --}}
        <button
            type="button"
        ...
        {{-- Tombol menghapus seluruh data BUJK pada halaman (aktif jika data tersedia) --}}
        <button
            type="button"
...
<div class="mt-5 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-slate-200 text-xs">
            ...
            {{-- Body data tabel menggunakan perulangan BUJK --}}
            <tbody class="divide-y divide-slate-100 bg-white">
                ...
                {{-- Tampilan jika data BUJK kosong --}}
                <tr>
...
<div class="mt-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
    ...
    {{-- Navigasi halaman (pagination) data BUJK --}}
