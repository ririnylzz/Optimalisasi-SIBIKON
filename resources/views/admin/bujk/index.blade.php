                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button
                                type="submit"
                                data-import-submit
                                class="rounded-xl bg-indigo-600 px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-indigo-500 disabled:cursor-not-allowed">
                                Proses Import
                            </button>
                        </div>
                    </div>
        ...
        <div
            ...
            <div class="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        File {{ $importSummary['filename'] ?? 'BUJK' }} selesai diproses.
                    </p>
                </div>
            ...
            <div class="px-5 py-5">
                <div class="rounded-2xl border border-emerald-500/30 bg-emerald-500 px-4 py-4 text-white">
                    ...
                    <p class="mt-1 text-xs leading-5 text-white/95">
                        Duplikat dihitung dari baris dengan NIB yang sama di dalam file, lalu digabung agar tidak masuk sebagai data ganda.
                    </p>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (bujkImportForm) {
            bujkImportForm.addEventListener('submit', function() {
                if (!bujkImportForm.checkValidity()) {
                    return;
                }

                const submitButton = bujkImportForm.querySelector('[data-import-submit]');
