...
<div class="space-y-6">
    ...
    <<div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
        <x-dashboard-chart-card title="Asosiasi TKK" canvas="asosiasiTkkChart" height="h-[280px]" />
        <x-dashboard-chart-card title="Kualifikasi SKK" canvas="kualifikasiChart" height="h-[280px]" />
        <x-dashboard-chart-card title="Jabatan Kerja SKK" canvas="jabkerChart" height="h-[280px]" />
    </div>
...
<script>
    ...
    barChart(
        'asosiasiTkkChart',
        @json(collect($asosiasiTkk)->pluck('label')),
        @json(collect($asosiasiTkk)->pluck('value')),
        true
    );

    barChart(
        'kualifikasiChart',
        @json(collect($kualifikasiSkk)->pluck('label')),
        @json(collect($kualifikasiSkk)->pluck('value')),
        false
    );

    barChart(
        'jabkerChart',
        @json(collect($jabkerSkk)->pluck('label')),
        @json(collect($jabkerSkk)->pluck('value')),
        false
    );
</script>
@endpush