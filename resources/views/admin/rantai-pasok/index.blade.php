            ...
            <div class="px-5 py-4">
                <form id="rantai-import-form" action="{{ route('admin.rantai-pasok.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="submit" data-import-submit class="rounded-xl bg-indigo-600 px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-indigo-500 disabled:cursor-not-allowed disabled:opacity-80">
                            Proses Import
                        </button>
                    </div>
                </form>
            ...
            <div class="flex items-start justify-between gap-4 border-b border-slate-200 px-5 py-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        File {{ $importSummary['filename'] ?? 'Rantai Pasok' }} selesai diproses.
                    </p>
                </div>
