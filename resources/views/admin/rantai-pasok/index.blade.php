...
<div class="space-y-4">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <form id="rantai-filter-form" method="GET" action="{{ route('admin.rantai-pasok') }}" class="mt-8 grid grid-cols-1 gap-3 text-xs md:grid-cols-2 xl:grid-cols-4">
            ...
            <div>
                <label for="bidang_usaha" class="mb-2 block text-xs font-semibold text-slate-600">Bidang usaha</label>
                <select
                    id="bidang_usaha"
                    name="bidang_usaha"
            ...
            <div class="px-5 py-4">
                <form id="rantai-import-form" action="{{ route('admin.rantai-pasok.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm leading-6 text-slate-600">
                        ...
                        <p>2. Header yang didukung: nama, bidang_usaha, alamat, kabupaten, provinsi, kontak, email, website.</p>
                ...
                <form
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                        <div>
                            ...
                            <input id="nama" type="text" name="nama" value="{{ old('nama', $editingRantaiPasok?->nama) }}" placeholder="Nama perusahaan / penyedia" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('nama')
                        ...
                        <div>
                            ...
                            <input id="bidang_usaha" type="text" name="bidang_usaha" value="{{ old('bidang_usaha', $editingRantaiPasok?->bidang_usaha) }}" placeholder="Bidang usaha" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('bidang_usaha')
                                <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <textarea id="alamat" name="alamat" rows="2" placeholder="Alamat" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500">{{ old('alamat', $editingRantaiPasok?->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                        <div>
                            ...
                            <input id="provinsi" type="text" name="provinsi" value="{{ old('provinsi', $editingRantaiPasok?->provinsi) }}" placeholder="Provinsi" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('provinsi')
                                <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input id="kabupaten" type="text" name="kabupaten" value="{{ old('kabupaten', $editingRantaiPasok?->kabupaten) }}" placeholder="Kabupaten / Kota" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('kabupaten')
                                <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-3">
                        <div>
                            ...
                            <input id="kontak" type="text" name="kontak" value="{{ old('kontak', $editingRantaiPasok?->kontak) }}" placeholder="Nomor kontak" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('kontak')
                                <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email', $editingRantaiPasok?->email) }}" placeholder="Email" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('email')
                                <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            <label for="website" class="mb-2 block text-sm font-medium text-slate-700">Website</label>
                            <input id="website" type="text" name="website" value="{{ old('website', $editingRantaiPasok?->website) }}" placeholder="Website" class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500" />
                            @error('website')
                                <p class="mt-1 text-xs text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const bidangSelect = document.getElementById('bidang_usaha');
