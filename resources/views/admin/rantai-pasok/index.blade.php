                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                name="provinsi"
                                value="{{ old('provinsi', $editingRantaiPasok?->provinsi) }}"
                                placeholder="Provinsi"
                                data-required="Provinsi wajib diisi."
                                class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10" />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                name="kabupaten"
                                value="{{ old('kabupaten', $editingRantaiPasok?->kabupaten) }}"
                                placeholder="Kabupaten / Kota"
                                data-required="Kabupaten / Kota wajib diisi."
                                class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10" />
