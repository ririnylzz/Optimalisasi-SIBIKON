                            ...
                            <table class="w-full min-w-[1180px] border-collapse text-left text-sm">
                                <thead>
                                    <tr class="border-y border-slate-200 bg-slate-50 text-[11px] uppercase tracking-wide text-slate-700">
                                        ...
                                        <th class="min-w-[280px] border-r border-slate-200 px-4 py-4 font-extrabold">Nama</th>
                                        <th class="min-w-[150px] border-r border-slate-200 px-4 py-4 font-extrabold">Bidang Usaha</th>
                                    </tr>
                                </thead>
