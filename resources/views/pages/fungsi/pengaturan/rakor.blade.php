                    ...
                    <table class="w-full min-w-[900px] border-collapse text-left">
                        ...
                        <tbody class="divide-y divide-[#e6ebf2] text-sm text-slate-600">
                            <tr class="align-top">
                                ...
                                <td class="px-5 py-6 leading-7">08 Oktober 2025</td>
                                <td class="px-5 py-6 leading-7">
                                    Auditorium Kantor Walikota Bontang Jl. Moch. Roem No. 1 Kelurahan Bontang Lestari, Kecamatan Bontang Selatan, Kota Bontang
                                </td>
                                <td class="px-5 py-6 font-bold uppercase">Kota Bontang</td>
                                <td class="px-5 py-6">
                            ...
                            <tr class="align-top">
                                ...
                                <td class="px-5 py-6 leading-7">11 Desember 2024</td>
                                <td class="px-5 py-6 leading-7">
                                    Hotel Kyriad Sadurengas, Kabupaten Paser Jl. Kesuma Bangsa KM. 5 Tanah Grogot, Paser
                                </td>
                                <td class="px-5 py-6 font-bold uppercase">Paser</td>
                                <td class="px-5 py-6">
                                    <span class="inline-flex rounded-md bg-blue-600 px-3 py-2 text-xs font-extrabold text-white">
                                        Instansi Pemerintah
                                    </span>
